...
class WeightWithFilterPredictionProvider(private val minProb: Double, private val m1: Double, private val m2: Double, private val commitSize: Double) : PredictionProvider {
